...
const Greeting = () => {
    return (
        <>
            ...
            <MainContainer>
                <BodyTitle>
                    환경개선과 기술융합의 선봉에 서 있는 블루비에스,<br />
                    여러분과 함께 더 나은 미래를 만들어갑니다.
                </BodyTitle>
                <Body>
                    ...
                    또한 다양한 연구기관 및 대학과 함께 연구 네트워크를 구축하여 변화하는 환경에 맞추어 수질분야와 특 물 재이용분야에서 한걸음 앞선 기술을 선보이며 신기술, 특허, 녹색기술, 품질인증 등의 기술력을 확보하는 등 환경전문업체로 지속적 성장을 해나가고 있습니다.<br /><br />
